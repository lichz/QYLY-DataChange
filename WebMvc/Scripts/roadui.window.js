...
; RoadUI.Window = function () {
    ...
    this.open = function (options) {
        ...
        if (this.opts.flag == true) {
            title = "";
            tcss = 'style="background: none;"';
            bcss = 'background:url(../../Images/login/login_bg.png) no-repeat;background-size:cover;border:0; ';
        }
        var $maindiv = $('<div id="' + this.opts.id + '" class="window_maindiv" style="left:' + this.opts.left + 'px;top:' + this.opts.top + 'px;width:' + this.opts.width + 'px;height:' + this.opts.height + 'px;z-index:' + this.opts.zindex + '; ' + bcss + '"></div>', $openerDocument);

        var $titlediv = $('<div id="' + this.opts.id + '_titlediv" class="window_title" ' + tcss + '></div>', $openerDocument);
        ...
        var $titlediv_title = $('<div class="' + (this.opts.showico ? 'window_title_title_ico' : 'window_title_title') + '">' + title + '</div>', $openerDocument);
