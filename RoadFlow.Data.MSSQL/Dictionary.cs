...
namespace RoadFlow.Data.MSSQL
{
    public class Dictionary : RoadFlow.Data.Interface.IDictionary
    {
        ...
        /// <summary>
        /// 获取所有文章类型
        /// 魅力青羊ParentID:3032A035-4C9A-4859-A11B-123511BB8455
        /// 楼宇资讯ParentID:24964F47-B1BE-4819-BA3B-7F6FF930C4DD
        /// </summary>
        /// <returns></returns>
        public DataTable GetArticleType()
        {
            string sql = "select * from Dictionary where ParentID=@QYFeatures or ParentID=@BuildingInformation";
            SqlParameter[] param = new SqlParameter[] 
            {
                 new SqlParameter("@QYFeatures","4D50326C-C2CB-4C00-A36B-892E9BB365C1"),
                new SqlParameter("@BuildingInformation","0731C316-8058-4CC6-BE6D-CA0538DEFB4B")
            };
            return dbHelper.GetDataTable(sql,param);
        }
        public DataTable GetByID(Guid id)
        {
            string sqlstr = string.Format("select *  from {0} where ID='{1}' ", "Dictionary", id);
