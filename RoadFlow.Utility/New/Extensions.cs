...
public static class Extensions {
    ...
    public static string GetInitials(this string @string) {
    ...
    //[Obsolete("新代码请不要使用该方法!")]
    //public static decimal Convert<decimal>(this object @object) {
    //    if (@object.IsDecimal()) {
    ...
    //[Obsolete("新代码请不要使用该方法!")]
    //public static DateTime Convert<DateTime>(this object @object) {
    ...
    //[Obsolete("新代码请不要使用该方法!")]
    //public static Guid Convert<Guid>(this object @object) {
    //    if (@object.IsGuid()) {
    ...
    //[Obsolete("新代码请不要使用该方法!")]
    //public static int Convert<int>(this object @object) {
    //    if (@object.IsInt()) {
    ...
    //[Obsolete("新代码请不要使用该方法!")]
    //public static int Convert<int>(this object @object, int @default) {
    //    if (@object.IsInt()) {
    //        return int.Parse(@object.ToString());
    //    }
    //    return @default;
