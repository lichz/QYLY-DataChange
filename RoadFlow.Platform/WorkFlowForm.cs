...
namespace RoadFlow.Platform
{
    ...
    public class WorkFlowForm
    {
        ...
        public string GetDefaultValueSelect(string value)
        {
            ...
            options.AppendFormat("<option value=\"@DateTime.Now.ToShortTimeString()\" {0}>短时间格式(23:59)</option>", "22" == value ? "selected=\"selected\"" : "");
            options.AppendFormat("<option value=\"@DateTime.Now.ToString(&#34;HH时mm分&#34;)\" {0}>长时间格式(23时59分)</option>", "23" == value ? "selected=\"selected\"" : "");
