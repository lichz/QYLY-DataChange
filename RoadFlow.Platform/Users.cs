...
namespace RoadFlow.Platform
{
    public class Users
    {
        ...
        /// <summary>
        /// 当前用户关系组织（UsersRelation.OrganizeID）
        /// </summary>
        public static Guid CurrentFirstRelationID {
            get {
                List<Data.Model.UsersRelation> relations = new UsersRelation().GetAllByUserID(CurrentUserID);
                return relations.Count==0 ? Guid.Empty : relations.FirstOrDefault().OrganizeID;
            }
        }
